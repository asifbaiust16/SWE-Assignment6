...
public class MyStudentRecordsMgmtApp {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Print Hello, World, Hello World based of 5 and 7 multiplicity :");
        System.out.println("-------------------------------------");
       ...
       System.out.println("Second biggest in example1: " + findSecondBiggest(inputArray1));
       System.out.println("Second biggest in example2: " + findSecondBiggest(inputArray2));
    }
